...
class AddFieldsToTargetRuleFormObserverTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->_segmentHelper = $this->createPartialMock(\Magento\CustomerSegment\Helper\Data::class, ['isEnabled', 'addSegmentFieldsToForm']);
    ...
    public function testAddFieldsToTargetRuleForm()
    {
        ...
        $collectionFactory = $this->createPartialMock(\Magento\Framework\Data\Form\Element\CollectionFactory::class, ['create']);
