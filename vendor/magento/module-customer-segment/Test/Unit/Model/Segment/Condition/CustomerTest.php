...
class CustomerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->customerAttributes = $this->createMock(\Magento\CustomerSegment\Model\Segment\Condition\Customer\Attributes::class);
        $this->customerNewsletter = $this->createMock(\Magento\CustomerSegment\Model\Segment\Condition\Customer\Newsletter::class);
        $this->customerStorecredit = $this->createMock(\Magento\CustomerSegment\Model\Segment\Condition\Customer\Storecredit::class);
