...
class ShoppingcartTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->cartAmount = $this->createMock(\Magento\CustomerSegment\Model\Segment\Condition\Shoppingcart\Amount::class);
        $this->cartItemsquantity = $this->createMock(\Magento\CustomerSegment\Model\Segment\Condition\Shoppingcart\Itemsquantity::class);
        $this->cartProductsquantity = $this->createMock(\Magento\CustomerSegment\Model\Segment\Condition\Shoppingcart\Productsquantity::class);
