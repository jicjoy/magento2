    ...
    protected function setUp()
    {
        ...
        $this->block = $this->getMockForAbstractClass(
            ...
            [
                ...
                $this->createPartialMock(\Magento\Directory\Model\ResourceModel\Region\CollectionFactory::class, ['create']),
                $this->createPartialMock(\Magento\Directory\Model\ResourceModel\Country\CollectionFactory::class, ['create']),
