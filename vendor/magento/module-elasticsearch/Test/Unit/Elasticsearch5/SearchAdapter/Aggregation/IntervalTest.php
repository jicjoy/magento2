...
class IntervalTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @return void
     */
    public function testLoadPrev(string $data, string $index, string $lower, array $queryResult, $expected)
    {
        $this->processQuery($queryResult);
     ...
     * @return void
     */
    public function testLoadNext(string $data, string $rightIndex, string $upper, array $queryResult, $expected)
    {
        $this->processQuery($queryResult);
     ...
     * @return void
     */
    private function processQuery(array $queryResult)
    {
