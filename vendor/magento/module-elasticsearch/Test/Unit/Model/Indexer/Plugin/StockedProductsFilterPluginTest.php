...
class StockedProductsFilterPluginTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->stockConfigurationMock = $this->getMockBuilder(StockConfigurationInterface::class)->getMock();
        $this->stockStatusRepositoryMock = $this->getMockBuilder(StockStatusRepositoryInterface::class)->getMock();
     ...
     */
    public function testBeforePrepareProductIndex()
    {
