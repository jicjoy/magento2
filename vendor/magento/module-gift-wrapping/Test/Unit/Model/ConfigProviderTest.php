...
class ConfigProviderTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->totalsMock = $this->createPartialMock(\Magento\Quote\Model\Cart\Totals::class, ['getGwCardPrice', '__wakeUp']);
        ...
        $this->wrappingCollectionFactory = $this->createPartialMock(\Magento\GiftWrapping\Model\ResourceModel\Wrapping\CollectionFactory::class, ['create']);
        $this->wrappingCollection = $this->createMock(\Magento\GiftWrapping\Model\ResourceModel\Wrapping\Collection::class);
        $this->wrappingItem = $this->createPartialMock(\Magento\GiftWrapping\Model\Wrapping::class, ['getBasePrice', 'setTaxClassKey', 'getImageUrl', 'getId']);
        $this->quoteIdMaskFactory = $this->createPartialMock(\Magento\Quote\Model\QuoteIdMaskFactory::class, ['create']);
        $this->quoteIdMask = $this->createPartialMock(\Magento\Quote\Model\QuoteIdMask::class, ['load', 'getMaskedId']);
        $this->taxClassKeyFactory = $this->createPartialMock(\Magento\Tax\Api\Data\TaxClassKeyInterfaceFactory::class, ['create']);
    ...
    public function testGetConfig()
    {
        ...
        $item = $this->createPartialMock(\Magento\Quote\Model\ResourceModel\Quote\Item::class, ['getProductId', 'hasGwId', 'getGwId', 'getId', 'getProduct']);
