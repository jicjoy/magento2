...
class NodeTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->abstractCollectionMock = $this->getMockBuilder(
     ...
     * @param \PHPUnit_Framework_MockObject_Matcher_Invocation $setScopeIsCalled
    ...
    public function testAppendPageToNodes(
        array $storeIds,
        \PHPUnit_Framework_MockObject_Matcher_Invocation $setScopeIsCalled,
        int $setScopeIdCallTimes
    ) {
