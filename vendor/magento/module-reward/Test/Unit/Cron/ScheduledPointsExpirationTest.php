...
class ScheduledPointsExpirationTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->rewardDataMock = $this->createPartialMock(\Magento\Reward\Helper\Data::class, ['isEnabled', 'isEnabledOnFront', 'getGeneralConfig']);
        $this->historyItemFactoryMock = $this->createPartialMock(\Magento\Reward\Model\ResourceModel\Reward\HistoryFactory::class, ['create']);
