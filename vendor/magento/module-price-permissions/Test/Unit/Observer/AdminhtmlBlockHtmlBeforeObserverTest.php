...
class AdminhtmlBlockHtmlBeforeObserverTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->observerData = $this->createPartialMock(\Magento\PricePermissions\Observer\ObserverData::class,
        ...
        $this->_observer = $this->getMockBuilder(\Magento\PricePermissions\Observer\AdminhtmlBlockHtmlBeforeObserver::class)
        ...
        $this->_varienObserver = $this->createPartialMock(\Magento\Framework\Event\Observer::class, ['getBlock', 'getEvent']);
    ...
    public function testAdminhtmlBlockHtmlBeforeProductOptions()
    {
        ...
        $childBlock = $this->createPartialMock(\Magento\Backend\Block\Template::class, ['setCanEditPrice', 'setCanReadPrice']);
