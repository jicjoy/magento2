...
/**
 * Test for Magento\AdminGws\Ui\Component\Plugin\Catalog\Product\MassAction class.
 */
class MassActionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAfterIsActionAllowed(
        ...
        string $actionType,
        int $callGetIsAllNum = 0,
        bool $isAll = true,
        int $callHasStoreAccessNum = 0,
        bool $hasStoreAccess = true
    ) {
