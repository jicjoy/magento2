...
class Role extends \Magento\Framework\DataObject
{
    ...
    public function __construct(
        ...
        $this->websiteRepository = $websiteRepository ?: ObjectManager::getInstance()
    ...
    public function setAdminRole($role)
    {
        if ($role) {
            ...
            foreach ($this->websiteRepository->getList() as $website) {
                if (!in_array($website->getId(), $this->getRelevantWebsiteIds())) {
                    $this->_disallowedWebsiteIds[] = $website->getId();
                }
            }
