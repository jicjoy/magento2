...
class RolePermissionAssigner
{
     ...
     * @param CollectionFactory|null $storeGroupsFactory
     */
    public function __construct(
        ...
        CollectionFactory $storeGroupsFactory = null
    ) {
        $this->role = $role;
        ...
        $this->storeGroupsFactory = $storeGroupsFactory ?: ObjectManager::getInstance()->get(CollectionFactory::class);
    }
