...
use Magento\CatalogEvent\Model\Event as EventEntity;
...
class Event extends AbstractEvent implements IdentityInterface
{
    ...
    public function getIdentities()
    {
        ...
        if ($event) {
            ...
            //Using this events-related tag, not broader category-products tag.
            return $categoryId
                ? [EventEntity::CACHE_EVENT_CATEGORY_TAG . '_' . $categoryId]
                : [];
        }
    }
}
