...
class Event extends \Magento\Framework\Model\AbstractModel implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    const CACHE_EVENT_CATEGORY_TAG = 'catalog_event_category';
    ...
    public function getIdentities()
    {
        return [
            ...
            //Using this specific tag to prevent invalidation of cache not
            //related to events
            self::CACHE_EVENT_CATEGORY_TAG . '_' . $this->getCategoryId(),
        ];
    }
}
