...
class CreditmemoDataImportObserver implements ObserverInterface
{
    ...
    /**
     * Updates credit memo totals.
     * If base total is zero, sets credit memo as zero allowed.
     *
     * @param Creditmemo $creditMemo
    ...
    {
        $creditMemo->setBaseGrandTotal(max(0, $creditMemo->getBaseGrandTotal() - $baseAmount));
        $creditMemo->setGrandTotal(max(0, $creditMemo->getGrandTotal() - $convertedAmount));
